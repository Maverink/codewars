...
//  of the integers to the left of N is equal to the sum of the integers to the right
...
function findEvenIndex(arr) {
	...
	for (i = 0; i < arr.length; i++) {
		portion1 = arr.slice(0, i);
		portion2 = arr.slice(i + 1);

		if (
			portion1.reduce(function(a, b) {
				return a + b;
			}, 0) ==
			portion2.reduce(function(a, b) {
				return a + b;
			}, 0)
		) {
			return i;
